  ...
  return (
    <div>
       <div className='container mx-auto'>
        <h1 className='font-bold text-3xl ml-4 mb-6'>ADMIN MANAGEMENT</h1>
        <div className=' p-4'>
    ...
    <table class="w-full text-sm text-left text-black dark:text-black">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-200 dark:border-gray-100 hover:bg-gray-1000 dark:hover:bg-gray-300">
                ...
                <td class="flex items-center py-8 px-6 space-x-3">
                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{user.is_active?<span className='' onClick={()=>handleBlockUser(user.id)}>Block</span>:<span className='' onClick={()=>handleBlockUser(user.id)}>Unblock</span>}</a>
