            ...
            <div className="container mx-auto">
              ...
              <div date-rangepicker class="flex justify-end mr-24  mb-4">
                <div class="relative">
                  <input
                   onChange={(evt) => {setFrom(evt.target.value)}}
                    name="start"
                    type="date"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  pl-10   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <button
                  type="button"
                  onClick={data}
                  class="py-2 px-2 ml-4 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 "
                >
                  SEARCH
                </button>
              </div>
