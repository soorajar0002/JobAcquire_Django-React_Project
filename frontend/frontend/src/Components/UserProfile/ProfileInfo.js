  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className=" mt-6 text-gray-900 bg-white border border-gray-300  hover:bg-gray-100   font-normal rounded-md text-sm px-4 py-1 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
        >
          SAVE
        </button>
      </form>
