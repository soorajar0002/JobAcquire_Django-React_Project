    ...
    <div className="container mx-auto ">
      ...
      <div className="grid gap-6 lg:grid-cols-3    mx-4 mt-5  ">
        <div className="p-4 text-center shadow-2xl mb-6">
          ...
          <button
            type="button"
            class=" bg-white border border-gray-300 focus:outline-none   font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 "
          >
            RESUME
          </button>
        ...
        <div className="lg:col-span-2  p-4   ">
          <div className="shadow-2xl p-4 my-2">
            ...
            <div className="mt-6 font-medium mx-6">
              ...
              <h1 className="my-2">
                Email : <span className="pl-2">{users.email}</span>
              </h1>
              <h1 className="my-2">
                Phone : <span className="pl-2">{users.phone_number}</span>
              </h1>
              <h1 className="my-2">
                Desired Job :{" "}
          ...
          <div className="shadow-2xl p-4 my-2">
            ...
            <div className="mt-6 font-medium mx-6">
              ...
              <h1 className="my-2">
                Company : <span className="pl-2">{usersProfile.company}</span>
              </h1>

              <h1 className="my-2">
                From : <span className="pl-2">{usersProfile.joining_year}</span>
              </h1>
              <h1 className="my-2">
                To : <span className="pl-2">{usersProfile.passout_year}</span>
              </h1>
            </div>
          </div>
          <div className="shadow-2xl p-4 my-2">
            ...
            <div className="mt-6 font-medium mx-6">
              <h1 className="my-2">
                Degree :<span className="pl-2">{usersProfile.degree}</span>{" "}
              </h1>
              <h1 className="my-2">
                College :<span className="pl-2">{usersProfile.college}</span>
              </h1>
              <h1 className="my-2">
                From : <span className="pl-2">{usersProfile.start}</span>
              </h1>
              <h1 className="my-2">
                To :<span className="pl-2">{usersProfile.end}</span>{" "}
              </h1>
              <h1 className="my-2">
                Percentage :
