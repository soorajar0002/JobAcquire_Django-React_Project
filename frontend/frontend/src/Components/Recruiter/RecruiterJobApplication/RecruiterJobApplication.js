    ...
    <div className="h-screen">
      <div className="relative overflow-x-auto  sm:rounded-lg mx-6 md:mx-48 mb-20 ">
        ...
        <div className="mb-6">
              ...
              <Link to="/recruiter_application_report"> <button type="button" class="text-gray-100 bg-black border border-gray-300 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2 mr-2 ">REPORT</button> </Link> 
            ...
            {applications?.map((application) => (
              ...
              <tr className=" border-b  bg-gray-50 px-2 text-center">
               <Link to={`/recruiter_user_profile/${application.user_id}`}><th
                ...
                <td className="px-6 py-4"> <Link to={`/chats/${createConversationName(application.first_name)}`}><a href="" className="font-medium   hover:underline"><BsFillChatRightFill/></a></Link> </td>
                <td className="px-6 ">
                  <select
