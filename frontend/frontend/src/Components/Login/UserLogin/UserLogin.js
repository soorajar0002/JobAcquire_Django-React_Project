          ...
          <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-center pt-1 mb-12 pb-1">
                <button
                  className="inline-block login-button  py-4 bg-black text-white font-medium text-sm leading-tight uppercase rounded shadow-md  hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out  mb-3 hover:scale-105 duration-300 ease-in-out"
                  type="submit"
            ...
            <div className="text-center mt-4">
              ...
              <Link to="/register">
                {' '}
                <button className=" btn-login mt-4  text-white py-4  font-medium text-xs hover:scale-105 duration-300 ease-in-out">
                  {' '}
                  CREATE ACCOUNT{' '}
                </button>
              </Link>
          ...
          <div className="md:w-8/12 lg:w-6/12 mb-12 md:mb-0 justify-center text-center recruiter-login">
            ...
            <div>
              <Link to="/recruiter_login">
                {' '}
                <button
                  className="inline-block login-button rec-login-button py-4  btn-login text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-dark-700 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out mb-3 hover:scale-105 duration-300 ease-in-out"
                  type="button"
                  data-mdb-ripple="true"
                  data-mdb-ripple-color="light"
                >
